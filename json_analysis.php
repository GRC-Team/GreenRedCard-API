...
// neangan balance semua kelas SMP
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND g.School = 'SMP'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND g.School = 'SMP'" ;
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"ALL-SMP\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";

// neangan balance semua kelas SMA
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND g.School = 'SMA'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND g.School = 'SMA'" ;
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"ALL-SMA\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";

// neangan balance semua kelas cowo
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND s.Gender = 'M'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND s.Gender = 'M'" ;
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"ALL-MALE\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";

// neangan balance semua kelas cewe
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND s.Gender = 'F'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND s.Gender = 'F'" ;
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"ALL-FEMALE\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";

// neangan balance semua kelas cowo SMP
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND s.Gender = 'M' AND g.School = 'SMP'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND s.Gender = 'M' AND g.School = 'SMP'" ;
                $result2=mysqli_query($connect, $sql2) or die(mysql_error()); 
                if(mysqli_num_rows($result2)> 0){ 
               while($row2 = mysqli_fetch_assoc($result2)){ 
                $pont2 = $row2['Point'];
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"ALL-MALE-SMP\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";

// neangan balance semua kelas cewe SMP
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND s.Gender= 'F' AND g.School = 'SMP'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND s.Gender = 'F' AND g.School = 'SMP'" ;
                $result2=mysqli_query($connect, $sql2) or die(mysql_error()); 
                if(mysqli_num_rows($result2)> 0){ 
               while($row2 = mysqli_fetch_assoc($result2)){ 
                $pont2 = $row2['Point'];
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"ALL-FEMALE-SMP\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";


// neangan balance semua kelas cowo SMA
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND s.Gender = 'M' AND g.School= 'SMA'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND s.Gender = 'M' AND g.School = 'SMA'" ;
                $result2=mysqli_query($connect, $sql2) or die(mysql_error()); 
                if(mysqli_num_rows($result2)> 0){ 
               while($row2 = mysqli_fetch_assoc($result2)){ 
                $pont2 = $row2['Point'];
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"ALL-MALE-SMA\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";

// neangan balance semua kelas cewe SMA
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND s.Gender = 'F' AND g.School = 'SMA'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND s.Gender = 'F' AND g.School = 'SMA'" ;
                $result2=mysqli_query($connect, $sql2) or die(mysql_error()); 
                if(mysqli_num_rows($result2)> 0){ 
               while($row2 = mysqli_fetch_assoc($result2)){ 
                $pont2 = $row2['Point'];
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"ALL-FEMALE-SMA\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";
...
// neangan balance semua kelas 10 cowo
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND g.Level = '10' AND s.Gender= 'Male'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND g.Level = '10' AND s.Gender= 'Male'" ;
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"10-MALE\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";

// neangan balance semua kelas 10 cewe
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND g.Level = '10' AND s.Gender= 'Female'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND g.Level = '10' AND s.Gender= 'Female'" ;
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"10-FEMALE\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";
...
// neangan balance semua kelas 11 cowo
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND g.Level = '11' AND s.Gender= 'Male'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND g.Level = '11' AND s.Gender= 'Male'" ;
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"11-MALE\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";

// neangan balance semua kelas 11 cewe
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND g.Level = '11' AND s.Gender= 'Female'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND g.Level = '11' AND s.Gender= 'Female'" ;
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"11-FEMALE\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";
...
// neangan balance semua kelas 12 cowo
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND g.Level = '12' AND s.Gender= 'Male'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND g.Level = '12' AND s.Gender= 'Male'" ;
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"12-MALE\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";

// neangan balance semua kelas 12 cewe
$qty= 0;
$sqlx="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'green' AND g.Level = '12' AND s.Gender= 'Female'" ;
...
$qty2= 0;
$sql2="SELECT * FROM student s, cards c, description d, time t, user u, grade g WHERE c.StudentID = s.StudentID AND c.DescID=d.DescID AND c.TimeID=t.TimeID AND c.UserID=u.UserID AND s.GradeID = g.GradeID AND d.Type = 'red' AND g.Level = '12' AND s.Gender= 'Female'" ;
...
$balance = $qty-$qty2;
echo "{\"Grade\":\"12-FEMALE\", \"Balance\":\"$balance\", \"Total_Green\":\"$qty\", \"Total_Red\":\"$qty2\"},";
